...
## Includes
 ...
 or other content like css, or html which lives in separate files. The classical example is including a header and Drawer. Suppose we have the following directory structure:
